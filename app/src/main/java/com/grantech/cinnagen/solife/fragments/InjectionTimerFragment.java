...
public class InjectionTimerFragment extends InjectionBaseFragment
{
    ...
    private void toggleCountdown() {
        ...
        inProgress = true;
        timer.start();
        alarmId = Alarms.schedule(activity.getApplicationContext(), AlarmReceiver.class, System.currentTimeMillis() + delay * 1000, 1, "", getResources().getString(R.string.app_name), getResources().getString(R.string.injection_timer_fine), null, "ftp://dim-22", null, null);
