...
public class TipsFragment extends BaseFragment
{
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState)
    {
        ...
        expandableListAdapter.addChild(R.string.tips_1_title, new ArrayList<Integer>(){{add(R.string.tips_1_message);}});
        ...
        expandableListAdapter.addChild(R.string.tips_4_title, new ArrayList<Integer>(){{add(R.string.tips_4_message_0);add(R.string.tips_4_message_1);add(R.string.tips_4_message_2);add(R.string.tips_4_message_3);add(R.string.tips_4_message_4);}});
